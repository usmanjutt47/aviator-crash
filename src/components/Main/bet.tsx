...
const Bet = ({ index, add, setAdd }: BetProps) => {
  ...
  // const { index } = props;
  const mutableState = state as ContextDataType & Record<string, any>;

  const minus = (type: FieldNameType) => {
    let value = mutableState;
    if (type === "betAmount") {
