            ...
            <div className="modal-content">
              ...
              <div className="modal-body m-body-bg">
                <div className="step">
                  ...
                  <p>
                    Make a bet, or even two at the same time, and wait for the
                    round to start.
                  </p>
                </div>
                <div className="step">
                  ...
                  <p>
                    Watch the Lucky Plane. Your win is your bet multiplied by
                    the current multiplier. Cash out before the plane flies away
                ...
                <div className="step">
                  ...
                  <p>
                    Cash out before the plane disappears and your winnings are
              ...
              <div className="modal-body p-1r">
                ...
                <div className="rules-list pt-2">
                  ...
                  <ul className="list-group">
                    <li className="list-group-item">
                      {" "}
                      Select an amount and press the “Bet” button to make a
                      bet.{" "}
                    </li>
                    <li className="list-group-item">
                      {" "}
                ...
                <div className="rules-list pt-2">
                  ...
                  <ul className="list-group">
                    <li className="list-group-item">
                      ...
                      can see all bets that are being made in the current
                      round.{" "}
                    </li>
                    <li className="list-group-item">
                      {" "}
